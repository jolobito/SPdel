...
def plot_compare_tree(path, tree, motudf, nocons=False, names=True, save=False):
    ...
    true_width=tree.treenode.height
    false_width=2 * len(AllMOTUs_dict)
    tree = tree.mod.edges_scale_to_root_height(2 * len(AllMOTUs_dict))
...
def print_options():
    ...
    print("    -A           ABGD analysis.\n")
    print("    -S           ASAP analysis.\n")
    print("    -P           PTP analysis.\n")
    print("    -G           GMYC analysis.\n")
    print("    -T           bPTP analysis.\n")
    print("    -M           mPTP analysis.\n")
    print("    -X           Specify the path of the CSV file including the MOTUs names obtained from any external method (e.g. BIN).\n")
